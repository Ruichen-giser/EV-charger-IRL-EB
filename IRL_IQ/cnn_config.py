...
DEFAULT_LR = 2e-5
# 分组 LR（baseline + bottleneck_film）：base=encoder，head/embed/film 为倍率
DEFAULT_LR_HEAD_MULT = 1.5
DEFAULT_LR_EMBED_MULT = 5.0
DEFAULT_LR_FILM_MULT = 5.0
DEFAULT_FILM_WARMUP_STEPS = 50_000
DEFAULT_LR_DECAY_STEP = 800_000
DEFAULT_LR_DECAY_MULT = 0.1
